import{G as e,J as t,L as n,R as r,z as i}from"./i18n-f4fS4CFJ.js";import{n as a}from"./provider-izh9zx-p.js";import{t as o}from"./ChevronDown-CuoP4fzW.js";import{t as s}from"./Copy-DYoeH4MI.js";import{a as c,i as l,n as u,r as d,t as f}from"./Share-BiiZ_x33.js";import{t as p}from"./Edit-C7XacxV_.js";import{t as m}from"./Trash-BwQu9V0y.js";import{t as h}from"./XLg-COofvWqT.js";import{t as g}from"./button-DWJJYJAM.js";import{a as _,c as v,d as y,i as b,l as x,n as S,o as C,r as w,s as T,t as E,u as D}from"./dropdown-BM7lNoo1.js";var O=t(e()),k=i(),A=(0,O.forwardRef)(({children:e,variant:t=`default`,size:r=`sm`,selectedVariant:i=`primary`,icon:s,selected:c=!1,open:l=!1,clearable:u=!1,hideArrow:d=!1,disabled:f=!1,className:p,onClick:m,onClear:g,..._},v)=>{let[y,b]=(0,O.useState)(!1),x=a(`Dropdown`),S=(0,O.useCallback)(e=>{e.stopPropagation(),e.preventDefault(),g?.(e)},[g]),C=c&&u&&y&&!l;return(0,k.jsxs)(`button`,{ref:v,type:`button`,disabled:f,className:n(`lg-dropdown-button`,t!=="default"&&`lg-dropdown-button--${t}`,r!==`sm`&&`lg-dropdown-button--${r}`,c&&`lg-dropdown-button--selected`,c&&i!==`primary`&&`lg-dropdown-button--selected-${i}`,l&&`lg-dropdown-button--open`,f&&`lg-dropdown-button--disabled`,p),onClick:m,onMouseEnter:()=>b(!0),onMouseLeave:()=>b(!1),..._,children:[s&&(0,k.jsx)(`span`,{className:`lg-dropdown-button__icon`,children:s}),e&&(0,k.jsx)(`span`,{className:`lg-dropdown-button__label`,children:e}),!d&&(C?(0,k.jsx)(`span`,{className:`lg-dropdown-button__clear`,onMouseDown:S,role:`button`,"aria-label":x.clear,children:(0,k.jsx)(h,{size:12})}):(0,k.jsx)(o,{size:16,className:`lg-dropdown-button__arrow`}))]})});A.displayName=`DropdownButton`;function j(){return(0,k.jsx)(E,{items:[{key:`edit`,label:`Edit`},{key:`copy`,label:`Copy`},{key:`share`,label:`Share`}],children:(0,k.jsx)(g,{children:`Actions`})})}var M=`import { Dropdown, Button } from "lingee-ui";
