import{A as e,D as t,x as n,y as r}from"./dist-DjLZdxEA.js";import{t as i}from"./DemoBox-DEznk3dE.js";var a=e(t()),o=n(),s=a.forwardRef(({className:e,variant:t=`default`,orientation:n=`horizontal`,spacing:i,style:a,...s},c)=>{let l=r(`lg-divider`,`lg-divider--${n}`,`lg-divider--${t}`,e),u=i?n===`horizontal`?{marginTop:i,marginBottom:i,...a}:{marginLeft:i,marginRight:i,...a}:a;return(0,o.jsx)(`div`,{ref:c,role:`separator`,"aria-orientation":n,className:l,style:u,...s})});s.displayName=`Divider`;function c(){return(0,o.jsxs)(`div`,{children:[(0,o.jsx)(`p`,{children:`上方内容`}),(0,o.jsx)(s,{}),(0,o.jsx)(`p`,{children:`下方内容`})]})}var l=`import { Divider } from "lingee-ui";
