import{C as e,M as t,k as n,x as r}from"./dist-DCLsKzkS.js";import{t as i}from"./dist-Cpdi29qC.js";import{n as a,r as o,t as s}from"./Threedots-C-EsDKi7.js";import{n as c}from"./provider-DMuMa5yQ.js";import{t as l}from"./ChevronRight-B43NjOIN.js";import{t as u}from"./DemoBox-D1az5eCZ.js";import{t as d}from"./dropdown-CmIq85fW.js";var f=t(n()),p=e(),m=i(`lg-breadcrumb`,{variants:{size:{sm:`lg-breadcrumb--sm`,md:`lg-breadcrumb--md`}},defaultVariants:{size:`md`}}),h=f.forwardRef(({className:e,items:t,size:n=`md`,separator:i,maxItems:u=0,itemsBeforeCollapse:f=1,itemsAfterCollapse:h=1,onBack:g,itemMaxWidth:_,"aria-label":v=`Breadcrumb`,...y},b)=>{let x=c(`Breadcrumb`),S=i??(n===`sm`?(0,p.jsx)(l,{}):(0,p.jsx)(a,{})),C=t.length-1,w=u>0&&t.length>u&&f+h<t.length,T;if(w){let e=t.slice(f,t.length-h);T=[...t.slice(0,f).map((e,t)=>({kind:`item`,item:e,index:t})),{kind:`collapse`,hidden:e},...t.slice(t.length-h).map((e,n)=>({kind:`item`,item:e,index:t.length-h+n}))]}else T=t.map((e,t)=>({kind:`item`,item:e,index:t}));let E=e=>(0,p.jsxs)(p.Fragment,{children:[e.icon&&(0,p.jsx)(`span`,{className:`lg-breadcrumb__icon`,children:e.icon}),e.label!=null&&e.label!==``&&(0,p.jsx)(`span`,{className:`lg-breadcrumb__label`,style:_?{maxWidth:_}:void 0,children:e.label})]}),D=(e,t)=>{let n=E(e);return t?(0,p.jsx)(`span`,{className:`lg-breadcrumb__item lg-breadcrumb__item--current`,"aria-current":`page`,children:n}):e.disabled?(0,p.jsx)(`span`,{className:`lg-breadcrumb__item lg-breadcrumb__item--disabled`,"aria-disabled":`true`,children:n}):e.href?(0,p.jsx)(`a`,{className:`lg-breadcrumb__item`,href:e.href,onClick:e.onClick,children:n}):e.onClick?(0,p.jsx)(`button`,{type:`button`,className:`lg-breadcrumb__item`,onClick:e.onClick,children:n}):(0,p.jsx)(`span`,{className:`lg-breadcrumb__item`,children:n})},O=e=>e.map((e,t)=>({key:String(e.key??`bc-hidden-${t}`),icon:e.icon,disabled:e.disabled,label:e.href?(0,p.jsx)(`a`,{className:`lg-breadcrumb__menu-link`,href:e.href,onClick:e.onClick,children:e.label}):e.label,onSelect:e.href?void 0:()=>e.onClick?.()}));return(0,p.jsxs)(`nav`,{ref:b,className:r(m({size:n}),e),"aria-label":v,...y,children:[g&&(0,p.jsx)(`button`,{type:`button`,className:`lg-breadcrumb__back`,onClick:g,"aria-label":x.back,children:(0,p.jsx)(o,{})}),(0,p.jsx)(`ol`,{className:`lg-breadcrumb__list`,children:T.map((e,t)=>{let n=t===T.length-1,r=e.kind===`collapse`?`bc-collapse`:e.item.key??e.index;return(0,p.jsxs)(`li`,{className:`lg-breadcrumb__cell`,children:[e.kind===`collapse`?(0,p.jsx)(d,{items:O(e.hidden),contentProps:{align:`start`,className:`lg-breadcrumb-menu`},children:(0,p.jsx)(`button`,{type:`button`,className:`lg-breadcrumb__ellipsis`,"aria-label":x.more,children:(0,p.jsx)(s,{})})}):D(e.item,e.index===C),!n&&(0,p.jsx)(`span`,{className:`lg-breadcrumb__separator`,"aria-hidden":`true`,children:S})]},r)})})]})});h.displayName=`Breadcrumb`;function g(){return(0,p.jsx)(h,{items:[{key:`home`,label:`首页`,href:`#`},{key:`list`,label:`列表页`,href:`#`},{key:`detail`,label:`详情页`}]})}var _=`import { Breadcrumb } from "lingee-ui";
