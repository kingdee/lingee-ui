import{I as e,L as t,R as n,W as r,q as i}from"./i18n-DmENUXWN.js";import{n as a}from"./provider-BibnZ_0z.js";import{t as o}from"./ChevronDown-CrJiypz-.js";import{t as s}from"./Copy-dVg0joIn.js";import{a as c,i as l,n as u,r as d,t as f}from"./Share-BEwusfJ1.js";import{t as p}from"./Edit-CoueEjc6.js";import{t as m}from"./Trash-D2LoRvg0.js";import{t as h}from"./XLg-FrzAEp-1.js";import{t as g}from"./button-Civ1Cgfe.js";import{a as _,c as v,d as y,i as b,l as x,n as S,o as C,r as w,s as T,t as E,u as D}from"./dropdown-VTSu-ViN.js";var O=i(r()),k=n(),A=(0,O.forwardRef)(({children:t,variant:n=`default`,size:r=`sm`,selectedVariant:i=`primary`,icon:s,selected:c=!1,open:l=!1,clearable:u=!1,hideArrow:d=!1,disabled:f=!1,className:p,onClick:m,onClear:g,..._},v)=>{let[y,b]=(0,O.useState)(!1),x=a(`Dropdown`),S=(0,O.useCallback)(e=>{e.stopPropagation(),e.preventDefault(),g?.(e)},[g]),C=c&&u&&y&&!l;return(0,k.jsxs)(`button`,{ref:v,type:`button`,disabled:f,className:e(`lg-dropdown-button`,n!=="default"&&`lg-dropdown-button--${n}`,r!==`sm`&&`lg-dropdown-button--${r}`,c&&`lg-dropdown-button--selected`,c&&i!==`primary`&&`lg-dropdown-button--selected-${i}`,l&&`lg-dropdown-button--open`,f&&`lg-dropdown-button--disabled`,p),onClick:m,onMouseEnter:()=>b(!0),onMouseLeave:()=>b(!1),..._,children:[s&&(0,k.jsx)(`span`,{className:`lg-dropdown-button__icon`,children:s}),t&&(0,k.jsx)(`span`,{className:`lg-dropdown-button__label`,children:t}),!d&&(C?(0,k.jsx)(`span`,{className:`lg-dropdown-button__clear`,onMouseDown:S,role:`button`,"aria-label":x.clear,children:(0,k.jsx)(h,{size:12})}):(0,k.jsx)(o,{size:16,className:`lg-dropdown-button__arrow`}))]})});A.displayName=`DropdownButton`;function j(){return(0,k.jsx)(E,{items:[{key:`edit`,label:`Edit`},{key:`copy`,label:`Copy`},{key:`share`,label:`Share`}],children:(0,k.jsx)(g,{children:`Actions`})})}var M=`import { Dropdown, Button } from "lingee-ui";
...
`;function N(){return(0,k.jsx)(E,{items:[{key:`edit`,label:`Edit`,icon:(0,k.jsx)(p,{})},{key:`copy`,label:`Copy`,icon:(0,k.jsx)(s,{})},{type:`separator`},{key:`delete`,label:`Delete`,icon:(0,k.jsx)(m,{}),danger:!0}],children:(0,k.jsx)(g,{children:`Menu with icons`})})}var P=`import { Dropdown, Button } from "lingee-ui";
...
`;function F(){return(0,k.jsx)(E,{items:[{key:`edit`,label:`Edit`,icon:(0,k.jsx)(p,{})},{type:`separator`},{key:`delete`,label:`Delete`,icon:(0,k.jsx)(m,{}),danger:!0}],children:(0,k.jsx)(g,{children:`With danger action`})})}var I=`import { Dropdown, Button } from "lingee-ui";
...
`;function z(){return(0,k.jsx)(E,{items:[{type:`label`,label:`Edit`},{key:`edit`,label:`Edit`,icon:(0,k.jsx)(p,{})},{key:`copy`,label:`Copy`,icon:(0,k.jsx)(s,{})},{type:`separator`},{type:`label`,label:`Share`},{key:`share`,label:`Share with team`,icon:(0,k.jsx)(f,{})},{type:`separator`},{type:`label`,label:`Danger zone`},{key:`delete`,label:`Delete`,icon:(0,k.jsx)(m,{}),danger:!0}],children:(0,k.jsx)(g,{children:`Grouped menu`})})}var B=`import { Dropdown, Button } from "lingee-ui";
...
`,Z=[{key:`auto`,label:`Auto`,icon:(0,k.jsx)(u,{size:16}),description:`Balances performance and cost`},{key:`fast`,label:`Fast`,icon:(0,k.jsx)(t,{size:16}),description:`Quick responses for light tasks`},{key:`deep`,label:`Deep`,icon:(0,k.jsx)(c,{size:16}),description:`Deep reasoning for complex analysis`},{key:`expert`,label:`Expert`,icon:(0,k.jsx)(d,{size:16}),description:`Professional analysis and precise decisions`}],Q={auto:(0,k.jsx)(u,{size:16}),fast:(0,k.jsx)(t,{size:16}),deep:(0,k.jsx)(c,{size:16}),expert:(0,k.jsx)(d,{size:16})};function $(){let[e,t]=(0,O.useState)(!1),[n,r]=(0,O.useState)(`fast`),i=Z.map(e=>({...e,onSelect:()=>r(e.key)}));return(0,k.jsxs)(`div`,{style:{display:`flex`,gap:16,alignItems:`center`},children:[(0,k.jsx)(E,{open:e,onOpenChange:t,items:i,selectedKeys:[n],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8,style:{minWidth:200}},children:(0,k.jsx)(A,{size:`lg`,icon:Q[n],open:e,children:Z.find(e=>e.key===n)?.label??`Select a mode`})}),(0,k.jsx)(E,{items:i,selectedKeys:[n],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8,style:{minWidth:200}},children:(0,k.jsx)(A,{children:Z.find(e=>e.key===n)?.label??`Select a mode`})})]})}var ee=`/**
...
`;export{P as _,K as a,j as b,U as c,B as d,z as f,F as g,I as h,Y as i,H as l,L as m,$ as n,G as o,R as p,X as r,W as s,ee as t,V as u,N as v,M as y};