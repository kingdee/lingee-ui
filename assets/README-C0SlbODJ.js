import{i as e,n as t,s as n,t as r}from"./utils-D3YijGPp.js";import{n as i}from"./provider-DitETfxs.js";import{t as a}from"./XLg-CzRsxE59.js";import{t as o}from"./button-uswttEhB.js";import{a as s,i as c,n as l,r as u,t as d}from"./dist-C9Eja3iZ.js";import{t as f}from"./DemoBox-D5W_RP2Q.js";var p=n(e()),m=t(),h=({open:e,onOpenChange:t,placement:n=`right`,size:f=380,title:h,extra:g,closable:_=!0,footer:v,modal:y=!1,mask:b=!0,destroyOnHidden:x=!0,zIndex:S,className:C,style:w,children:T})=>{let E=i(`Drawer`),[D,O]=(0,p.useState)(e);(0,p.useEffect)(()=>(e?(O(!0),document.body.style.overflow=`hidden`):document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[e]);let k=(0,p.useCallback)(()=>{!e&&x&&O(!1)},[e,x]),A=(0,p.useCallback)(e=>{e||t(!1)},[t]),j=n===`left`||n===`right`,M=typeof f==`number`?`${f}px`:f,N=j?{width:M,maxWidth:`100vw`}:{height:M,maxHeight:`100vh`};return(0,m.jsx)(d,{open:e,onOpenChange:A,modal:!1,children:(0,m.jsxs)(c,{forceMount:void 0,children:[D&&b&&(0,m.jsx)(`div`,{className:r(`lg-drawer__overlay`,!e&&`lg-drawer__overlay--closing`),style:S?{zIndex:S}:void 0,onClick:()=>{y||t(!1)}}),(0,m.jsx)(u,{className:r(`lg-drawer__content`,`lg-drawer__content--${n}`,C),style:{...N,...w,...S?{zIndex:S+1}:{}},"data-placement":n,onAnimationEnd:k,onInteractOutside:e=>{e.preventDefault()},onPointerDownOutside:e=>{e.preventDefault()},onFocusOutside:e=>{e.preventDefault()},children:D&&(0,m.jsxs)(m.Fragment,{children:[(h||g||_)&&(0,m.jsxs)(`div`,{className:`lg-drawer__header`,children:[h&&(0,m.jsx)(s,{className:`lg-drawer__title`,asChild:typeof h!=`string`,children:typeof h==`string`?(0,m.jsx)(`span`,{children:h}):h}),(0,m.jsxs)(`div`,{className:`lg-drawer__header-actions`,children:[g,_&&(0,m.jsx)(l,{asChild:!0,"aria-label":E.close,children:(0,m.jsx)(o,{className:`lg-drawer__close`,variant:`text`,size:`lg`,icon:(0,m.jsx)(a,{size:18})})})]})]}),(0,m.jsx)(`div`,{className:`lg-drawer__body`,children:T}),v!=null&&(0,m.jsx)(`div`,{className:`lg-drawer__footer`,children:v})]})})]})})};h.displayName=`Drawer`;function g(){let[e,t]=(0,p.useState)(!1);return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(o,{onClick:()=>t(!0),children:`打开抽屉`}),(0,m.jsxs)(h,{open:e,onOpenChange:t,title:`基础抽屉`,children:[(0,m.jsx)(`p`,{children:`这是抽屉的内容区域。`}),(0,m.jsx)(`p`,{children:`点击遮罩层或关闭按钮可关闭。`})]})]})}var _=`import { useState } from "react";
...
`;function v(){let[e,t]=(0,p.useState)(!1),[n,r]=(0,p.useState)(`right`),i=e=>{r(e),t(!0)};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,m.jsx)(o,{onClick:()=>i(`left`),children:`左侧`}),(0,m.jsx)(o,{onClick:()=>i(`right`),children:`右侧`}),(0,m.jsx)(o,{onClick:()=>i(`top`),children:`顶部`}),(0,m.jsx)(o,{onClick:()=>i(`bottom`),children:`底部`})]}),(0,m.jsx)(h,{open:e,onOpenChange:t,title:`${n} 方向抽屉`,placement:n,children:(0,m.jsxs)(`p`,{children:[`从 `,n,` 方向滑出的抽屉。`]})})]})}var y=`import { useState } from "react";
import { Drawer, Button } from "lingee-ui";
...
`;function b(){let[e,t]=(0,p.useState)(!1);return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(o,{onClick:()=>t(!0),children:`打开带底部操作栏的抽屉`}),(0,m.jsxs)(h,{open:e,onOpenChange:t,title:`编辑信息`,footer:(0,m.jsxs)(`div`,{style:{display:`flex`,justifyContent:`flex-end`,gap:8},children:[(0,m.jsx)(o,{onClick:()=>t(!1),children:`取消`}),(0,m.jsx)(o,{variant:`primary`,onClick:()=>t(!1),children:`保存`})]}),children:[(0,m.jsx)(`p`,{children:`这是带底部操作栏的抽屉，适用于表单编辑场景。`}),(0,m.jsx)(`p`,{children:`底部固定展示操作按钮，方便用户确认或取消。`})]})]})}var x=`import { useState } from "react";
import { Drawer, Button } from "lingee-ui";
...
`,(0,m.jsx)(f,{source:_,children:(0,m.jsx)(g,{})}),`
