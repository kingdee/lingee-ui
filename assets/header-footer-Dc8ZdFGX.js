...
`,te=[`top`,`bottom`,`left`,`right`],ne=[{key:`item-1`,label:`Item 1`},{key:`item-2`,label:`Item 2`},{key:`item-3`,label:`Item 3`}];function re(){return(0,j.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,alignItems:`center`,justifyContent:`center`,gap:48,padding:`72px 48px`},children:te.map(e=>(0,j.jsx)(O,{items:ne,contentProps:{side:e,align:`center`,sideOffset:8},children:(0,j.jsx)(v,{children:e[0].toUpperCase()+e.slice(1)})},e))})}var P=`import { Button, Dropdown } from "lingee-ui";
...
export default function PlacementDemo() {
  return (
    ...
    >
      {sides.map((side) => (
        <Dropdown key={side} items={items} contentProps={{ side, align: "center", sideOffset: 8 }}>
          <Button>{side[0].toUpperCase() + side.slice(1)}</Button>
        </Dropdown>
      ))}
    </div>
  );
...
`;function L(){return(0,j.jsx)(O,{items:[{key:`edit`,label:`Edit`,icon:(0,j.jsx)(f,{})},{type:`separator`},{key:`delete`,label:`Delete`,icon:(0,j.jsx)(h,{}),danger:!0}],children:(0,j.jsx)(v,{children:`With danger action`})})}var R=`import { Dropdown, Button } from "lingee-ui";
...
`;function z(){return(0,j.jsx)(O,{items:[{key:`view`,label:`View details`},{key:`export`,label:`Export (no permission)`,disabled:!0},{type:`separator`},{key:`delete`,label:`Delete`,icon:(0,j.jsx)(h,{}),danger:!0}],children:(0,j.jsx)(v,{children:`With disabled item`})})}var B=`import { Dropdown, Button } from "lingee-ui";
...
`;function U(){let[e,t]=(0,A.useState)(`newest`);return(0,j.jsxs)(O,{children:[(0,j.jsx)(x,{children:(0,j.jsx)(v,{children:`Sort and filter`})}),(0,j.jsxs)(w,{style:{minWidth:180},children:[(0,j.jsx)(S,{children:`Sort by`}),(0,j.jsxs)(y,{value:e,onValueChange:t,children:[(0,j.jsx)(T,{value:`newest`,children:`Newest first`}),(0,j.jsx)(T,{value:`oldest`,children:`Oldest first`}),(0,j.jsx)(T,{value:`name`,children:`By name`})]}),(0,j.jsx)(D,{}),(0,j.jsx)(S,{children:`Actions`}),(0,j.jsx)(E,{onSelect:()=>console.log(`refresh`),children:`Refresh list`}),(0,j.jsx)(E,{onSelect:()=>console.log(`export`),children:`Export data`})]})]})}var W=`import { useState } from "react";
import {
  Dropdown,
  DropdownTrigger,
  DropdownContent,
...
`;function G(){let[e,t]=(0,A.useState)(`zh-CN`);return(0,j.jsxs)(O,{children:[(0,j.jsx)(x,{children:(0,j.jsx)(v,{children:`Account`})}),(0,j.jsxs)(w,{side:`bottom`,align:`start`,style:{minWidth:200},children:[(0,j.jsx)(E,{children:`Profile settings`}),(0,j.jsxs)(b,{children:[(0,j.jsx)(k,{children:`Language`}),(0,j.jsx)(C,{children:(0,j.jsxs)(y,{value:e,onValueChange:t,children:[(0,j.jsx)(T,{value:`zh-CN`,children:`Chinese (Simplified)`}),(0,j.jsx)(T,{value:`en-US`,children:`English`}),(0,j.jsx)(T,{value:`ja-JP`,children:`Japanese`})]})})]}),(0,j.jsxs)(b,{children:[(0,j.jsx)(k,{children:`More settings`}),(0,j.jsxs)(C,{children:[(0,j.jsx)(E,{children:`Theme`}),(0,j.jsx)(E,{children:`Notifications`}),(0,j.jsx)(E,{children:`Export data`})]})]}),(0,j.jsx)(D,{}),(0,j.jsx)(E,{danger:!0,children:`Log out`})]})]})}var K=`import { useState } from "react";
import {
  Dropdown,
  DropdownTrigger,
  DropdownContent,
...
`,Y=[{key:`1`,label:`Expense Reviewer`},{key:`2`,label:`Data Analyst`},{key:`3`,label:`Doc Writing Assistant`}],X=[{key:`fast`,label:`Fast`},{key:`auto`,label:`Auto`},{key:`precise`,label:`Precise`}];function ie(){let[e,t]=(0,A.useState)(!1),[n,r]=(0,A.useState)(null),[i,a]=(0,A.useState)(!1),[o,s]=(0,A.useState)(`fast`),[l,u]=(0,A.useState)(!1),[d,f]=(0,A.useState)(`白话文`),[p,m]=(0,A.useState)(!1),[h,g]=(0,A.useState)(`fast`),[_,v]=(0,A.useState)(!1),[y,b]=(0,A.useState)(`1`),x=Y.map(e=>({key:e.key,label:e.label,onSelect:()=>r(e.key)})),S=Y.find(e=>e.key===n)?.label,C=[{key:`白话文`,label:`Plain Chinese`,onSelect:()=>f(`白话文`)},{key:`文言文`,label:`Classical Chinese`,onSelect:()=>f(`文言文`)}];return(0,j.jsxs)(`div`,{style:{display:`flex`,gap:12,flexWrap:`wrap`,alignItems:`center`},children:[(0,j.jsx)(O,{open:e,onOpenChange:t,items:x,selectedKeys:n?[n]:[],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8},children:(0,j.jsx)(M,{icon:(0,j.jsx)(c,{size:16}),open:e,selected:!!n,clearable:!!n,onClear:()=>r(null),children:S??`Select an agent`})}),(0,j.jsx)(O,{open:i,onOpenChange:a,items:X.map(e=>({...e,onSelect:()=>s(e.key)})),selectedKeys:[o],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8},children:(0,j.jsx)(M,{open:i,children:X.find(e=>e.key===o)?.label})}),(0,j.jsx)(O,{open:l,onOpenChange:u,items:C,selectedKeys:[d],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8},children:(0,j.jsx)(M,{open:l,selected:!0,children:C.find(e=>e.key===d)?.label})}),(0,j.jsx)(`div`,{style:{background:`#F1F1F6`,padding:`12px 16px`,borderRadius:12},children:(0,j.jsx)(O,{open:p,onOpenChange:m,items:X.map(e=>({...e,onSelect:()=>g(e.key)})),selectedKeys:[h],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8},children:(0,j.jsx)(M,{variant:`glassy`,open:p,children:X.find(e=>e.key===h)?.label??`All sections`})})}),(0,j.jsx)(O,{open:_,onOpenChange:v,items:Y.map(e=>({key:e.key,label:e.label,onSelect:()=>b(e.key)})),selectedKeys:y?[y]:[],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8},children:(0,j.jsx)(M,{icon:(0,j.jsx)(c,{size:16}),size:`lg`,selectedVariant:`purple`,open:_,selected:!!y,clearable:!!y,onClear:()=>b(null),children:Y.find(e=>e.key===y)?.label??`Select an agent`})})]})}var ae=`/**
...
`,Z=[{key:`auto`,label:`Auto`,icon:(0,j.jsx)(l,{size:16}),description:`Balances performance and cost`},{key:`fast`,label:`Fast`,icon:(0,j.jsx)(p,{size:16}),description:`Quick responses for light tasks`},{key:`deep`,label:`Deep`,icon:(0,j.jsx)(s,{size:16}),description:`Deep reasoning for complex analysis`},{key:`expert`,label:`Expert`,icon:(0,j.jsx)(u,{size:16}),description:`Professional analysis and precise decisions`}],oe={auto:(0,j.jsx)(l,{size:16}),fast:(0,j.jsx)(p,{size:16}),deep:(0,j.jsx)(s,{size:16}),expert:(0,j.jsx)(u,{size:16})};function se(){let[e,t]=(0,A.useState)(!1),[n,r]=(0,A.useState)(`fast`),i=Z.map(e=>({...e,onSelect:()=>r(e.key)}));return(0,j.jsxs)(`div`,{style:{display:`flex`,gap:16,alignItems:`center`},children:[(0,j.jsx)(O,{open:e,onOpenChange:t,items:i,selectedKeys:[n],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8,style:{minWidth:200}},children:(0,j.jsx)(M,{size:`lg`,icon:oe[n],open:e,children:Z.find(e=>e.key===n)?.label??`Select a mode`})}),(0,j.jsx)(O,{items:i,selectedKeys:[n],modal:!1,contentProps:{side:`bottom`,align:`start`,sideOffset:8,style:{minWidth:200}},children:(0,j.jsx)(M,{children:Z.find(e=>e.key===n)?.label??`Select a mode`})})]})}var Q=`/**
...
`;export{P as C,N as E,F as S,ee as T,B as _,Q as a,L as b,ie as c,K as d,G as f,V as g,H as h,ce as i,J as l,U as m,ue as n,se as o,W as p,le as r,ae as s,de as t,q as u,z as v,re as w,I as x,R as y};