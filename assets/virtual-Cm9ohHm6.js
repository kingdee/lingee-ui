...
`,ze=[{key:`folder`,title:`Workspace`,children:[{key:`session-1`,title:`Annual Finance Topic`},{key:`session-2`,title:`Sales Analysis Topic`},{key:`session-3`,title:`Customer Satisfaction`}]}];function Be(){return(0,Q.jsxs)(`div`,{style:{width:280},className:`demo-tree-actions`,children:[(0,Q.jsx)(`style`,{children:`
      ...
      `}),(0,Q.jsx)($,{treeData:ze,defaultExpandAll:!0,titleRender:e=>(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`span`,{className:`demo-tree-actions__label`,children:e.title}),(0,Q.jsxs)(`span`,{className:`demo-tree-actions__ops`,onClick:e=>e.stopPropagation(),children:[(0,Q.jsx)(f,{variant:`link`,size:`sm`,shape:`round`,icon:(0,Q.jsx)(s,{size:14}),children:`Edit`}),(0,Q.jsx)(f,{variant:`text`,size:`sm`,shape:`circle`,icon:(0,Q.jsx)(u,{size:16}),"aria-label":`Open dashboard`})]})]})})]})}var Ve=`import { Tree, Button } from "lingee-ui";
