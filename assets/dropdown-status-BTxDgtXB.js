import{R as e,W as t,q as n}from"./i18n-DmENUXWN.js";import{t as r}from"./empty-BKsw4Wy3.js";import{n as i,t as a}from"./select-AMxo9FLv.js";import{t as o}from"./Search-Bw8rRuUU.js";var s=n(t()),c=e();function l(){let[e,t]=(0,s.useState)(``);return(0,c.jsx)(a,{options:[{label:`View only`,value:`view`},{label:`Can edit`,value:`edit`},{label:`Admin`,value:`admin`}],value:e,onChange:e=>t(e),placeholder:`Select a permission`})}var u=`import { useState } from "react";
...
`;function T(){return(0,c.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16},children:[(0,c.jsx)(a,{options:[],loading:!0,placeholder:`Loading`}),(0,c.jsx)(a,{options:[],loadError:!0,placeholder:`Failed to load`}),(0,c.jsx)(a,{showSearch:!0,options:[],placeholder:`No results`})]})}var E=`import { Select } from "lingee-ui";
