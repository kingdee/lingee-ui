import{x as e}from"./dist-DjLZdxEA.js";import{t}from"./DemoBox-DEznk3dE.js";import{t as n}from"./tabs-b6yXCkNY.js";var r=e(),i=[{key:`tab1`,label:`选项一`},{key:`tab2`,label:`选项二`},{key:`tab3`,label:`选项三`}];function a(){return(0,r.jsx)(n,{items:i,defaultActiveKey:`tab1`})}var o=`import { Tabs } from "lingee-ui";
...
`,s=[{key:`tab1`,label:`选项一`},{key:`tab2`,label:`选项二`},{key:`tab3`,label:`选项三`}];function c(){return(0,r.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:24},children:[(0,r.jsxs)(`div`,{children:[(0,r.jsx)(`p`,{style:{marginBottom:8,color:`rgba(0,0,0,0.64)`},children:`segmented（默认，胶囊圆角）`}),(0,r.jsx)(n,{items:s,defaultActiveKey:`tab1`,variant:`segmented`})]}),(0,r.jsxs)(`div`,{children:[(0,r.jsx)(`p`,{style:{marginBottom:8,color:`rgba(0,0,0,0.64)`},children:`rounded（圆角矩形）`}),(0,r.jsx)(n,{items:s,defaultActiveKey:`tab1`,variant:`rounded`})]}),(0,r.jsxs)(`div`,{children:[(0,r.jsx)(`p`,{style:{marginBottom:8,color:`rgba(0,0,0,0.64)`},children:`solid`}),(0,r.jsx)(n,{items:s,defaultActiveKey:`tab1`,variant:`solid`})]}),(0,r.jsxs)(`div`,{children:[(0,r.jsx)(`p`,{style:{marginBottom:8,color:`rgba(0,0,0,0.64)`},children:`outline`}),(0,r.jsx)(n,{items:s,defaultActiveKey:`tab1`,variant:`outline`})]}),(0,r.jsxs)(`div`,{children:[(0,r.jsx)(`p`,{style:{marginBottom:8,color:`rgba(0,0,0,0.64)`},children:`underline`}),(0,r.jsx)(n,{items:s,defaultActiveKey:`tab1`,variant:`underline`})]})]})}var l=`import { Tabs } from "lingee-ui";
...
`,u=[{key:`tab1`,label:`选项一`},{key:`tab2`,label:`选项二`},{key:`tab3`,label:`选项三`}],d=[{name:`segmented`,value:`segmented`},{name:`rounded`,value:`rounded`},{name:`solid`,value:`solid`},{name:`outline`,value:`outline`}];function f(){return(0,r.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:32},children:[d.map(({name:e,value:t})=>(0,r.jsxs)(`div`,{children:[(0,r.jsx)(`p`,{style:{marginBottom:12,color:`rgba(0,0,0,0.64)`,fontWeight:500},children:e}),(0,r.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,r.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12},children:[(0,r.jsx)(`span`,{style:{width:32,fontSize:12,color:`rgba(0,0,0,0.46)`},children:`md`}),(0,r.jsx)(n,{items:u,defaultActiveKey:`tab1`,variant:t,size:`md`})]}),(0,r.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12},children:[(0,r.jsx)(`span`,{style:{width:32,fontSize:12,color:`rgba(0,0,0,0.46)`},children:`sm`}),(0,r.jsx)(n,{items:u,defaultActiveKey:`tab1`,variant:t,size:`sm`})]})]})]},t)),(0,r.jsxs)(`div`,{children:[(0,r.jsx)(`p`,{style:{marginBottom:12,color:`rgba(0,0,0,0.64)`,fontWeight:500},children:`glassy（玻璃高光滑块）`}),(0,r.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,r.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12},children:[(0,r.jsx)(`span`,{style:{width:80,fontSize:12,color:`rgba(0,0,0,0.46)`},children:`segmented`}),(0,r.jsx)(`div`,{style:{background:`#F1F1F6`,padding:`8px 12px`,borderRadius:12},children:(0,r.jsx)(n,{items:u,defaultActiveKey:`tab1`,variant:`segmented`,glassy:!0})})]}),(0,r.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12},children:[(0,r.jsx)(`span`,{style:{width:80,fontSize:12,color:`rgba(0,0,0,0.46)`},children:`rounded`}),(0,r.jsx)(`div`,{style:{background:`#F1F1F6`,padding:`8px 12px`,borderRadius:12},children:(0,r.jsx)(n,{items:u,defaultActiveKey:`tab1`,variant:`rounded`,glassy:!0})})]})]})]})]})}var p=`import { Tabs } from "lingee-ui";
...
`,_={title:`Tabs 页签`,description:`选项卡切换组件，支持多种风格变体和尺寸。`};function v(e){let n={code:`code`,h2:`h2`,h3:`h3`,p:`p`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(n.h2,{children:`基本用法`}),`
...
`,(0,r.jsxs)(n.p,{children:[`通过 `,(0,r.jsx)(n.code,{children:`variant`}),` 切换不同视觉风格：`,(0,r.jsx)(n.code,{children:`segmented`}),`（默认胶囊）、`,(0,r.jsx)(n.code,{children:`rounded`}),`（圆角矩形）、`,(0,r.jsx)(n.code,{children:`solid`}),`、`,(0,r.jsx)(n.code,{children:`outline`}),`、`,(0,r.jsx)(n.code,{children:`underline`}),`。`]}),`
`,(0,r.jsx)(t,{source:l,children:(0,r.jsx)(c,{})}),`
`,(0,r.jsx)(n.h2,{children:`尺寸`}),`
`,(0,r.jsxs)(n.p,{children:[`每种 variant 都支持 `,(0,r.jsx)(n.code,{children:`md`}),`（默认）和 `,(0,r.jsx)(n.code,{children:`sm`}),` 两种尺寸。`]}),`
`,(0,r.jsx)(t,{source:p,children:(0,r.jsx)(f,{})}),`
