import{i as e,n as t,s as n,t as r}from"./utils-D3YijGPp.js";import{t as i}from"./client-CNlZkXgB.js";import{n as a}from"./provider-DitETfxs.js";import{t as o}from"./ExclamationCircleFill-CWfdFwjt.js";import{t as s}from"./XLg-CzRsxE59.js";import{t as c}from"./button-uswttEhB.js";import{a as l,i as u,n as d,r as f,t as p}from"./dist-C9Eja3iZ.js";import{t as m}from"./DemoBox-D5W_RP2Q.js";var h=n(e()),g=t(),_=({open:e,onOpenChange:t,width:n=460,height:i,title:o,extra:m,closable:_=!0,footer:v,okText:y,cancelText:b,onOk:x,onCancel:S,okDanger:C=!1,okProps:w,cancelProps:T,modal:E=!1,mask:D=!0,destroyOnHidden:O=!0,zIndex:k,maxHeight:A=640,autoHeight:j=!1,className:M,style:N,children:P})=>{let F=a(`Dialog`),[I,L]=(0,h.useState)(e),[R,z]=(0,h.useState)(!1);(0,h.useEffect)(()=>(e?(L(!0),document.body.style.overflow=`hidden`):document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[e]);let B=(0,h.useCallback)(()=>{!e&&O&&L(!1)},[e,O]),V=(0,h.useCallback)(e=>{e||t(!1)},[t]),H=(0,h.useCallback)(async()=>{if(!x){t(!1);return}let e=x();if(e instanceof Promise){z(!0);try{await e}finally{z(!1)}}},[x,t]),U=(0,h.useCallback)(()=>{S?.(),t(!1)},[S,t]),W=j?void 0:typeof A==`number`?A-68:`calc(${A} - 68px)`,G=j?typeof A==`number`?`${A}px`:A:void 0,K=typeof n==`number`?`${n}px`:n,q=i==null?void 0:typeof i==`number`?`${i}px`:i;return(0,g.jsx)(p,{open:e,onOpenChange:V,modal:!1,children:(0,g.jsxs)(u,{forceMount:void 0,children:[I&&D&&(0,g.jsx)(`div`,{className:`lg-dialog__overlay${e?``:` lg-dialog__overlay--closing`}`,style:k?{zIndex:k}:void 0,onClick:()=>{E||t(!1)}}),(0,g.jsx)(f,{className:r(`lg-dialog__content`,M),style:{...N,width:K,maxWidth:K,...q?{height:q}:{},...G?{maxHeight:G}:{},...k?{zIndex:k+1}:{}},onAnimationEnd:B,onInteractOutside:e=>{e.preventDefault()},onPointerDownOutside:e=>{e.preventDefault()},onFocusOutside:e=>{e.preventDefault()},children:I&&(0,g.jsxs)(g.Fragment,{children:[_&&(0,g.jsx)(d,{asChild:!0,"aria-label":F.close,children:(0,g.jsx)(c,{className:`lg-dialog__close`,variant:`text`,size:`lg`,icon:(0,g.jsx)(s,{size:18})})}),(o||m)&&(0,g.jsxs)(`div`,{className:`lg-dialog__header`,children:[o&&(0,g.jsx)(l,{className:`lg-dialog__title`,asChild:typeof o!=`string`,children:typeof o==`string`?(0,g.jsx)(`span`,{children:o}):o}),m&&(0,g.jsx)(`div`,{className:`lg-dialog__header-actions`,children:m})]}),(0,g.jsx)(`div`,{className:`lg-dialog__body`,style:W===void 0?void 0:{maxHeight:W},children:P}),v==null?y||b?(0,g.jsxs)(`div`,{className:`lg-dialog__footer`,children:[b&&(0,g.jsx)(c,{variant:`text`,size:`lg`,onClick:U,...T,children:b}),y&&(0,g.jsx)(c,{variant:`primary`,size:`lg`,danger:C,loading:R,onClick:H,...w,children:y})]}):null:(0,g.jsx)(`div`,{className:`lg-dialog__footer`,children:v})]})})]})})};_.displayName=`Dialog`;var v=i(),y=null,b=null;function x(){y&&=(y.unmount(),null),b&&=(b.remove(),null)}function S({title:e,description:t,okText:n,cancelText:r,okDanger:i=!1,icon:a,content:s,width:l=320,footer:u,onOk:d,onCancel:f,onResult:p,...m}){let[v,y]=h.useState(!0),[b,S]=h.useState(!1),C=()=>{y(!1),f?.(),p(!1),setTimeout(x,200)},w=async()=>{if(d){let e=d();if(e instanceof Promise){S(!0);try{await e}finally{S(!1)}}}y(!1),p(!0),setTimeout(x,200)};return(0,g.jsx)(_,{...m,open:v,onOpenChange:e=>{e||C()},width:l,closable:m.closable??!1,modal:m.modal??!0,footer:u??(0,g.jsxs)(g.Fragment,{children:[r&&(0,g.jsx)(c,{variant:`text`,size:`lg`,onClick:C,children:r}),n&&(0,g.jsx)(c,{variant:`primary`,size:`lg`,danger:i,loading:b,onClick:w,children:n})]}),children:s??(0,g.jsxs)(`div`,{className:`lg-dialog-confirm`,children:[(0,g.jsx)(`span`,{className:`lg-dialog-confirm__icon`,children:a??(0,g.jsx)(o,{className:`lg-dialog-confirm__icon-default lg-dialog-confirm__icon-default--${i?`danger`:`primary`}`})}),(0,g.jsxs)(`div`,{className:`lg-dialog-confirm__content`,children:[e&&(0,g.jsx)(`span`,{className:`lg-dialog-confirm__title`,children:e}),t&&(0,g.jsx)(`p`,{className:`lg-dialog-confirm__desc`,children:t})]})]})})}function C(e){return x(),new Promise(t=>{b=document.createElement(`div`),b.className=`lg-dialog-confirm-container`,document.body.appendChild(b),y=(0,v.createRoot)(b),y.render((0,g.jsx)(S,{...e,onResult:t}))})}function w(){x()}var T=_;T.confirm=C,T.closeConfirm=w;function E(){let[e,t]=(0,h.useState)(!1);return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(c,{variant:`primary`,onClick:()=>t(!0),children:`打开对话框`}),(0,g.jsx)(T,{open:e,onOpenChange:t,title:`对话框标题`,okText:`确认`,cancelText:`取消`,onOk:()=>t(!1),onCancel:()=>t(!1),children:(0,g.jsx)(`p`,{style:{padding:`0 20px`,color:`rgba(0,0,0,0.64)`},children:`这是对话框的内容区域，可以放置任意内容。`})})]})}var D=`import { useState } from "react";
...
`;function O(){return(0,g.jsx)(c,{danger:!0,onClick:async()=>{await T.confirm({title:`确认删除`,description:`删除后不可恢复，确定要删除吗？`,okText:`删除`,cancelText:`取消`,okDanger:!0})&&console.log(`已确认删除`)},children:`删除`})}var k=`import { Dialog, Button } from "lingee-ui";
...
`;function A(){let[e,t]=(0,h.useState)(460),[n,r]=(0,h.useState)(!1),i=e=>{t(e),r(!0)};return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,g.jsx)(c,{onClick:()=>i(460),children:`小（460px）`}),(0,g.jsx)(c,{onClick:()=>i(640),children:`中（640px）`}),(0,g.jsx)(c,{onClick:()=>i(720),children:`大（720px）`})]}),(0,g.jsx)(T,{open:n,onOpenChange:r,title:`不同宽度对话框`,width:e,okText:`确认`,cancelText:`取消`,onOk:()=>r(!1),onCancel:()=>r(!1),children:(0,g.jsxs)(`p`,{style:{padding:`0 20px`,color:`rgba(0,0,0,0.64)`},children:[`当前宽度为 `,e,`px，适用于不同内容量的场景。`]})})]})}var j=`import { useState } from "react";
import { Dialog, Button } from "lingee-ui";
...
`;function M(){return(0,g.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,g.jsx)(c,{danger:!0,onClick:async()=>{await T.confirm({title:`确认删除项目`,description:`此操作将永久删除该项目及其所有数据，删除后无法恢复。`,okText:`删除项目`,cancelText:`取消`,okDanger:!0})&&console.log(`项目已删除`)},children:`删除项目`}),(0,g.jsx)(c,{danger:!0,onClick:async()=>{await T.confirm({title:`重置所有设置`,description:`确定要将所有设置恢复为默认值吗？当前的自定义配置将丢失。`,okText:`确认重置`,cancelText:`取消`,okDanger:!0})&&console.log(`设置已重置`)},children:`重置设置`})]})}var N=`import { Dialog, Button } from "lingee-ui";
...
`,(0,g.jsx)(m,{source:N,children:(0,g.jsx)(M,{})}),`
