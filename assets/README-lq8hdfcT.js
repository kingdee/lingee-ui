import{n as e}from"./utils-D3YijGPp.js";import{r as t}from"./provider-DitETfxs.js";import{t as n}from"./button-uswttEhB.js";import{t as r}from"./DemoBox-D5W_RP2Q.js";var i=e();function a(){return(0,i.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,i.jsx)(n,{onClick:()=>t.success(`操作成功！`),children:`成功`}),(0,i.jsx)(n,{onClick:()=>t.error(`出错了，请重试`),children:`错误`}),(0,i.jsx)(n,{onClick:()=>t.warning(`请注意，这是一条警告`),children:`警告`}),(0,i.jsx)(n,{onClick:()=>t.info(`这是一条信息提示`),children:`信息`})]})}var o=`import { toast, Button } from "lingee-ui";
...
`;function s(){return(0,i.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,i.jsx)(n,{onClick:()=>t.success({content:`保存成功`,duration:5e3}),children:`持续 5 秒`}),(0,i.jsx)(n,{onClick:()=>t.warning({content:`请确认操作`,duration:0,closable:!0}),children:`不自动关闭 + 可手动关闭`}),(0,i.jsx)(n,{onClick:()=>t.info({content:`可关闭的提示`,closable:!0}),children:`可手动关闭`})]})}var c=`import { toast, Button } from "lingee-ui";
