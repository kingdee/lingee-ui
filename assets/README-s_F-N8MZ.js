import{n as e}from"./utils-D3YijGPp.js";import{t}from"./Plus-Jh4gNWhn.js";import{t as n}from"./Search-_SuXcQq-.js";import{t as r}from"./button-uswttEhB.js";import{t as i}from"./DemoBox-D5W_RP2Q.js";var a=e();function o(){return(0,a.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,a.jsx)(r,{variant:`primary`,children:`主要按钮`}),(0,a.jsx)(r,{variant:`default`,children:`默认按钮`}),(0,a.jsx)(r,{variant:`text`,children:`文字按钮`})]})}var s=`import { Button } from "lingee-ui";
...
`;function c(){return(0,a.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12},children:[(0,a.jsx)(r,{variant:`primary`,size:`sm`,children:`小按钮`}),(0,a.jsx)(r,{variant:`primary`,size:`md`,children:`中按钮`}),(0,a.jsx)(r,{variant:`primary`,size:`lg`,children:`大按钮`})]})}var l=`import { Button } from "lingee-ui";
...
`;function u(){return(0,a.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,a.jsx)(r,{variant:`primary`,icon:(0,a.jsx)(t,{}),children:`新建`}),(0,a.jsx)(r,{variant:`default`,icon:(0,a.jsx)(n,{}),children:`搜索`}),(0,a.jsx)(r,{variant:`default`,icon:(0,a.jsx)(t,{}),iconPosition:`end`,children:`添加`})]})}var d=`import { Button } from "lingee-ui";
...
`;function f(){return(0,a.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,a.jsx)(r,{variant:`primary`,danger:!0,children:`主要危险`}),(0,a.jsx)(r,{variant:`default`,danger:!0,children:`默认危险`}),(0,a.jsx)(r,{variant:`text`,danger:!0,children:`文字危险`})]})}var p=`import { Button } from "lingee-ui";
...
`;function m(){return(0,a.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,a.jsx)(r,{variant:`primary`,loading:!0,children:`加载中`}),(0,a.jsx)(r,{variant:`default`,loading:!0,children:`加载中`})]})}var h=`import { Button } from "lingee-ui";
...
`;function g(){return(0,a.jsxs)(`div`,{style:{display:`flex`,gap:12},children:[(0,a.jsx)(r,{variant:`primary`,disabled:!0,children:`主要按钮`}),(0,a.jsx)(r,{variant:`default`,disabled:!0,children:`默认按钮`}),(0,a.jsx)(r,{variant:`text`,disabled:!0,children:`文字按钮`})]})}var _=`import { Button } from "lingee-ui";
