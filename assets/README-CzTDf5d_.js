import{A as e,D as t,x as n,y as r}from"./dist-DjLZdxEA.js";import{t as i}from"./client-sNJbLfZc.js";import{n as a}from"./provider-pWkB89tL.js";import{t as o}from"./ExclamationCircleFill-BeHppwiU.js";import{t as s}from"./XLg-BVUzbMOA.js";import{t as c}from"./DemoBox-DEznk3dE.js";import{t as l}from"./button-hSCyyIv7.js";import{a as u,i as d,n as f,r as p,t as m}from"./dist-BJNhbqWh.js";var h=e(t()),g=n(),_=({open:e,onOpenChange:t,width:n=460,height:i,title:o,extra:c,closable:_=!0,footer:v,okText:y,cancelText:b,onOk:x,onCancel:S,okDanger:C=!1,okProps:w,cancelProps:T,modal:E=!1,mask:D=!0,maskClassName:O,destroyOnHidden:k=!0,zIndex:A,maxHeight:j=640,autoHeight:M=!1,className:N,style:P,children:F})=>{let I=a(`Dialog`),[L,R]=(0,h.useState)(e),[z,B]=(0,h.useState)(!1);(0,h.useEffect)(()=>(e?(R(!0),document.body.style.overflow=`hidden`):document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[e]);let V=(0,h.useCallback)(()=>{!e&&k&&R(!1)},[e,k]),H=(0,h.useCallback)(e=>{e||t(!1)},[t]),U=(0,h.useCallback)(async()=>{if(!x){t(!1);return}let e=x();if(e instanceof Promise){B(!0);try{await e}finally{B(!1)}}},[x,t]),W=(0,h.useCallback)(()=>{S?.(),t(!1)},[S,t]),G=M?void 0:typeof j==`number`?j-68:`calc(${j} - 68px)`,K=M?typeof j==`number`?`${j}px`:j:void 0,q=typeof n==`number`?`${n}px`:n,J=i==null?void 0:typeof i==`number`?`${i}px`:i;return(0,g.jsx)(m,{open:e,onOpenChange:H,modal:!1,children:(0,g.jsxs)(d,{forceMount:void 0,children:[L&&D&&(0,g.jsx)(`div`,{className:r(`lg-dialog__overlay`,!e&&`lg-dialog__overlay--closing`,O),style:A?{zIndex:A}:void 0,onClick:()=>{E||t(!1)}}),(0,g.jsx)(p,{className:r(`lg-dialog__content`,N),style:{...P,width:q,maxWidth:q,...J?{height:J}:{},...K?{maxHeight:K}:{},...A?{zIndex:A+1}:{}},onAnimationEnd:V,onInteractOutside:e=>{e.preventDefault()},onPointerDownOutside:e=>{e.preventDefault()},onFocusOutside:e=>{e.preventDefault()},children:L&&(0,g.jsxs)(g.Fragment,{children:[_&&(0,g.jsx)(f,{asChild:!0,"aria-label":I.close,children:(0,g.jsx)(l,{className:`lg-dialog__close`,variant:`text`,size:`lg`,icon:(0,g.jsx)(s,{size:18})})}),(o||c)&&(0,g.jsxs)(`div`,{className:`lg-dialog__header`,children:[o&&(0,g.jsx)(u,{className:`lg-dialog__title`,asChild:typeof o!=`string`,children:typeof o==`string`?(0,g.jsx)(`span`,{children:o}):o}),c&&(0,g.jsx)(`div`,{className:`lg-dialog__header-actions`,children:c})]}),(0,g.jsx)(`div`,{className:`lg-dialog__body`,style:G===void 0?void 0:{maxHeight:G},children:F}),v==null?y||b?(0,g.jsxs)(`div`,{className:`lg-dialog__footer`,children:[b&&(0,g.jsx)(l,{variant:`text`,size:`lg`,onClick:W,...T,children:b}),y&&(0,g.jsx)(l,{variant:`primary`,size:`lg`,danger:C,loading:z,onClick:U,...w,children:y})]}):null:(0,g.jsx)(`div`,{className:`lg-dialog__footer`,children:v})]})})]})})};_.displayName=`Dialog`;var v=i(),y=null,b=null;function x(){y&&=(y.unmount(),null),b&&=(b.remove(),null)}function S({title:e,description:t,okText:n,cancelText:r,okDanger:i=!1,okProps:a,cancelProps:s,icon:c,content:u,contentRender:d,width:f=320,footer:p,onOk:m,onCancel:v,onResult:y,...b}){let[S,C]=h.useState(!0),[w,T]=h.useState(!1),[E,D]=h.useState(a?.disabled??!1),O=()=>{C(!1),v?.(),y(!1),setTimeout(x,200)},k=async()=>{if(m){let e=m();if(e instanceof Promise){T(!0);try{await e}catch{T(!1);return}T(!1)}}C(!1),y(!0),setTimeout(x,200)};return(0,g.jsx)(_,{...b,open:S,onOpenChange:e=>{e||O()},width:f,closable:b.closable??!1,modal:b.modal??!0,footer:p===void 0?(0,g.jsxs)(g.Fragment,{children:[r&&(0,g.jsx)(l,{variant:`text`,size:`lg`,...s,onClick:O,children:r}),n&&(0,g.jsx)(l,{variant:`primary`,size:`lg`,danger:i,loading:w,...a,disabled:E,onClick:k,children:n})]}):p,children:d?d({setOkDisabled:D}):u??(0,g.jsxs)(`div`,{className:`lg-dialog-confirm`,children:[(0,g.jsx)(`span`,{className:`lg-dialog-confirm__icon`,children:c??(0,g.jsx)(o,{className:`lg-dialog-confirm__icon-default lg-dialog-confirm__icon-default--${i?`danger`:`primary`}`})}),(0,g.jsxs)(`div`,{className:`lg-dialog-confirm__content`,children:[e&&(0,g.jsx)(`span`,{className:`lg-dialog-confirm__title`,children:e}),t&&(0,g.jsx)(`p`,{className:`lg-dialog-confirm__desc`,children:t})]})]})})}function C(e){return x(),new Promise(t=>{b=document.createElement(`div`),b.className=`lg-dialog-confirm-container`,document.body.appendChild(b),y=(0,v.createRoot)(b),y.render((0,g.jsx)(S,{...e,onResult:t}))})}function w(){x()}var T=_;T.confirm=C,T.closeConfirm=w;function E(){let[e,t]=(0,h.useState)(!1);return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(l,{variant:`primary`,onClick:()=>t(!0),children:`打开对话框`}),(0,g.jsx)(T,{open:e,onOpenChange:t,title:`对话框标题`,okText:`确认`,cancelText:`取消`,onOk:()=>t(!1),onCancel:()=>t(!1),children:(0,g.jsx)(`p`,{style:{padding:`0 20px`,color:`rgba(0,0,0,0.64)`},children:`这是对话框的内容区域，可以放置任意内容。`})})]})}var D=`import { useState } from "react";
