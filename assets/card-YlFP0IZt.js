import{a as e,n as t,t as n}from"./jsx-runtime-OQpaS_Dv.js";import{i as r,n as i,r as a,t as o}from"./EyeSlash-aznGqbhz.js";import{r as s,t as c}from"./empty-Cr_MbxWv.js";import{t as l}from"./LoaderCircle-duAtQU3_.js";import{t as u}from"./Search-f0zW-cZ0.js";import{t as d}from"./button-WsNqWjZh.js";var f=n();function p(){return(0,f.jsx)(c,{icon:u,description:`No data`})}var m=`import { Empty } from "lingee-ui";
import { Search } from "lingee-icon";

export default function BasicDemo() {
  return <Empty icon={Search} description="No data" />;
}
`;function h(){return(0,f.jsx)(c,{description:`No results found. Try a different keyword.`,children:(0,f.jsx)(d,{variant:`primary`,children:`Clear filters`})})}var g=`import { Empty, Button } from "lingee-ui";
