import{n as e}from"./utils-D3YijGPp.js";import{t}from"./empty-Bvi8zjwm.js";import{t as n}from"./Search-_SuXcQq-.js";import{t as r}from"./button-uswttEhB.js";import{t as i}from"./DemoBox-D5W_RP2Q.js";var a=e();function o(){return(0,a.jsx)(t,{icon:n,description:`暂无数据`})}var s=`import { Empty } from "lingee-ui";
import { Search } from "lingee-icon";

export default function BasicDemo() {
  return <Empty icon={Search} description="暂无数据" />;
}
`;function c(){return(0,a.jsx)(t,{description:`暂无搜索结果，请尝试其他关键词`,children:(0,a.jsx)(r,{variant:`primary`,style:{marginTop:12},children:`清除筛选条件`})})}var l=`import { Empty, Button } from "lingee-ui";
