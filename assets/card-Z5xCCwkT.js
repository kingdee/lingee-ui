import{a as e,n as t,t as n}from"./jsx-runtime-OQpaS_Dv.js";import{i as r,n as i,r as a,t as o}from"./EyeSlash-aznGqbhz.js";import{i as s}from"./card-0ZpTGA2w.js";import{t as c}from"./LoaderCircle-duAtQU3_.js";import{t as l}from"./Search-f0zW-cZ0.js";import{t as u}from"./button-BA4Y5u4W.js";import{t as d}from"./empty-BfxLPkYp.js";var f=n();function p(){return(0,f.jsx)(d,{icon:l,description:`No data`})}var m=`import { Empty } from "lingee-ui";
import { Search } from "lingee-icon";

export default function BasicDemo() {
  return <Empty icon={Search} description="No data" />;
}
`;function h(){return(0,f.jsx)(d,{description:`No results found. Try a different keyword.`,children:(0,f.jsx)(u,{variant:`primary`,children:`Clear filters`})})}var g=`import { Empty, Button } from "lingee-ui";
...
`;function _(){return(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:32},children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h4`,{style:{marginBottom:8,fontSize:13,color:`#666`},children:`lg - Page level`}),(0,f.jsx)(d,{size:`lg`,icon:l,description:`No results`})]}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h4`,{style:{marginBottom:8,fontSize:13,color:`#666`},children:`md - Inline (default)`}),(0,f.jsx)(d,{size:`md`,icon:l,description:`No results`})]}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h4`,{style:{marginBottom:8,fontSize:13,color:`#666`},children:`sm - Mini`}),(0,f.jsx)(d,{size:`sm`,icon:l,description:`No results`})]})]})}var v=`import { Empty } from "lingee-ui";
import { Search } from "lingee-icon";
...
`;function y(){return(0,f.jsxs)(`div`,{style:{display:`flex`,gap:48,flexWrap:`wrap`},children:[(0,f.jsx)(d,{icon:l,description:`No results`}),(0,f.jsx)(d,{icon:s,description:`No documents`}),(0,f.jsx)(d,{icon:o,description:`No permission`}),(0,f.jsx)(d,{icon:a,description:`Network error`}),(0,f.jsx)(d,{icon:r,description:`No notifications`})]})}var b=`import { Empty } from "lingee-ui";
...
`;function x(){return(0,f.jsx)(d,{icon:(0,f.jsx)(c,{size:24,spin:!0,color:`var(--lg-g-fg-color-black-faint)`}),description:`Loading, please wait...`})}var S=`import { Empty } from "lingee-ui";
...
`;function C(){return(0,f.jsx)(`div`,{style:{height:300,display:`flex`,alignItems:`center`,justifyContent:`center`,border:`1px dashed var(--lg-g-border-color-black-soft)`,borderRadius:8},children:(0,f.jsx)(d,{size:`lg`,icon:s,description:`No projects created yet`,children:(0,f.jsx)(u,{variant:`primary`,children:`New project`})})})}var w=`import { Empty, Button } from "lingee-ui";
...
`,T=e(t()),E={width:264,borderRadius:12,border:`1px solid var(--lg-g-border-color-black-subtle)`};function D(){let[e,t]=(0,T.useState)(0);return(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16},children:[(0,f.jsxs)(`div`,{style:E,children:[(0,f.jsx)(d.Card,{status:`loading`,description:`加载中...`}),(0,f.jsx)(d.Card,{status:`empty`,description:`暂无内容`}),(0,f.jsx)(d.Card,{status:`error`,description:e>0?`已重试 ${e} 次`:`加载失败`,onRetry:()=>t(e=>e+1)}),(0,f.jsx)(d.Card,{status:`error`,description:`加载失败`})]}),(0,f.jsxs)(`div`,{style:E,children:[(0,f.jsx)(d.Card,{status:`empty`,description:`暂无内容`,size:`md`}),(0,f.jsx)(d.Card,{status:`error`,description:`加载失败`,size:`md`,onRetry:()=>t(e=>e+1)})]}),(0,f.jsxs)(`div`,{style:{...E,width:360},children:[(0,f.jsx)(d.Card,{status:`empty`,description:`暂无内容`,size:`lg`}),(0,f.jsx)(d.Card,{status:`error`,description:`加载失败`,size:`lg`,onRetry:()=>t(e=>e+1)})]}),(0,f.jsxs)(`div`,{style:E,children:[(0,f.jsx)(d.Card,{status:`loading`,description:`加载中...`,variant:`inline`}),(0,f.jsx)(d.Card,{status:`error`,description:`加载失败`,variant:`inline`,onRetry:()=>t(e=>e+1)}),(0,f.jsx)(d.Card,{status:`empty`,description:`暂无对话`,variant:`inline`,icon:(0,f.jsx)(i,{size:16})})]})]})}var O=`import { useState } from "react";
