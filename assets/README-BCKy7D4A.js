import{C as e}from"./dist-DCLsKzkS.js";import{t}from"./Search-WaqXFOiJ.js";import{t as n}from"./XLg-BjLaNPLw.js";import{t as r}from"./DemoBox-D1az5eCZ.js";import{t as i}from"./input-CGtLObXk.js";var a=e();function o(){return(0,a.jsx)(i,{placeholder:`请输入内容`})}var s=`import { Input } from "lingee-ui";

export default function BasicDemo() {
  return <Input placeholder="请输入内容" />;
}
`;function c(){return(0,a.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,a.jsx)(i,{size:`sm`,placeholder:`Small 输入框`}),(0,a.jsx)(i,{size:`md`,placeholder:`Medium 输入框`}),(0,a.jsx)(i,{size:`lg`,placeholder:`Large 输入框`})]})}var l=`import { Input } from "lingee-ui";
...
`;function u(){return(0,a.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,a.jsx)(i,{prefix:(0,a.jsx)(t,{}),placeholder:`前缀图标`}),(0,a.jsx)(i,{suffix:(0,a.jsx)(n,{}),placeholder:`后缀图标`})]})}var d=`import { Input } from "lingee-ui";
...
`;function f(){return(0,a.jsx)(i,{defaultValue:`可清空内容`,allowClear:!0})}var p=`import { Input } from "lingee-ui";

export default function ClearableDemo() {
  return <Input defaultValue="可清空内容" allowClear />;
}
`;function m(){return(0,a.jsx)(i,{defaultValue:`禁用状态`,disabled:!0})}var h=`import { Input } from "lingee-ui";

export default function DisabledDemo() {
  return <Input defaultValue="禁用状态" disabled />;
}
`;function g(){return(0,a.jsx)(i,{defaultValue:`错误内容`,error:!0})}var _=`import { Input } from "lingee-ui";
